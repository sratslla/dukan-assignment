...
const TableDate = ({ orderId, orderDate, orderAmount, transactionFees }) => {
	return (
			...
			<tr>
				...
				<th>
					<div className="icon-container">
						...
						<TooltipComponent text="Transaction fees are charged as a percentage of the order amount according to your plan." />
					</div>
				</th>
			</tr>
			{data.map(
